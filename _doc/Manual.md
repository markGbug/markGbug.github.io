...
For instance, [Hello 2015])(https://auto/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://auto/2019/09/08/spacemacs-workflow/) with
...
![](http://auto/img/blog-sidebar.jpg)
...
sidebar-avatar: /img/love-dog.jpeg     # use absolute URL.
```
...
![](http://auto/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://auto/js-module-7day/"
---
```
...
- Brand new [Archive](https://auto/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
<img src="http://auto/img/blog-md-navbar.gif" width="320" />
